...
## go through the traj_list, compute the distance of each traj wrt trajs after it  
...
write.table(dmat_fr,"./data/dmat_juul_frechet.csv",sep=",",row.names = F, col.names = F)
