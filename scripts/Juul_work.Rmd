...
np.savetxt("./data/juul_boundary2.csv", results, delimiter=',')
## plotting ...
...
bnds_juul <- read_csv("./data/juul_boundary2.csv", col_names = FALSE) ## the columns are 
...
colnames(bnds_juul) <- temp 
## FIXME: this change of col names dhould be done in python!
write.table(bnds_juul,"./data/juul_boundary2.csv",sep=",",row.names = FALSE)
