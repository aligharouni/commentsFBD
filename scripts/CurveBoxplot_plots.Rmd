...
* `envdat.rds`: all envelope results for 
   * AG x nsamp = {100, 1000, 1e4} x J = {2, 50}
   * Juul x nsamp = {100, 1e4} x J = {2, 50}
   * fda: J=2, all comparisons
* `juul_boundary1.csv`: runs with Juul code with J = {2, 5, 10, 20, 30, 40, 50} x nsamp = 1000
...
juul1 <- read_csv("data/juul_boundary1.csv", col_names = TRUE) %>%
