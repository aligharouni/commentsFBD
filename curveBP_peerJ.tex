...
In this work, we first implimented \juul's primary sampling-based method for determining a curve's centrality which in nature is similar to FBD. In particular, the algorithm involves the following steps and was implemented in R (\todo {ref}).
