...
In our exploration of estimating the \emph{central set} out of an ensemble of curves, we compared applying measures of centrality directly to the curves versus to features derived from the curves.
